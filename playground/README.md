# Playground — the prod-replica track
...
> **Visual walkthroughs:** [`docs/index.html`](docs/index.html) — one page per exercise with diagrams, expected output, gotchas. Open it in a browser.
